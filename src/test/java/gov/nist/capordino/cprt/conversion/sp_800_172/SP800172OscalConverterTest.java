...
public class SP800172OscalConverterTest {
    /**
     * A CPRT file that contains a subset of 800-172 content.
     */
    final static File Cprt800172Sample = new File("src/test/resources/cprt_json/sp_800_172/cprt_SP_800_172_1_0_0_04-13-2026_172A_combined.json");
    ...
    static void initialize() throws StreamReadException, DatabindException, IOException {
        ...
        version.frameworkVersionIdentifier = "SP_800_172_1_0_0";
    ...
    void testConvertSP800172ToOscal() throws IOException, InterruptedException, InvalidFrameworkIdentifier {
        ...
        SP800172OscalConverter converter = new SP800172OscalConverter(version);
        Catalog catalog = converter.buildCatalog();
